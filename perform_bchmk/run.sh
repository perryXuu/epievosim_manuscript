...
wk_dir="/Users/px54/Documents/TB_software/manuscript_test/perform_bchmk"
code_path="/Users/px54/Documents/TB_software/V2_code/enivol_packaging"
...
python -u ${code_path}/enivol -path_config ${PATH_TO_THIS_CONFIG}
